<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:59:"D:\phpStudy\WWW\dt./application/index\view\index\index.html";i:1523431016;s:35:"public/static/index/common/nav.html";i:1525575336;s:38:"public/static/index/common/footer.html";i:1524878979;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8" />
...
<body>
    <header class="main bg-dark-img home-1">
        <div class="container">
            ...
            <div class="screens animation-domready">
                <p>
                    <img src="http://localhost/dt/public/static/index/img/home1_tab3.png" data-animation-delay="0.5s" data-animation="fadeInUp" class="animated" alt="" />
                    <img src="http://localhost/dt/public/static/index/img/home1_tab2.png" data-animation-delay="1.5s" data-animation="fadeInUp" class="animated" alt="" />
                    <img src="http://localhost/dt/public/static/index/img/home1_tab1.png" data-animation-delay="2.5s" data-animation="fadeInUp" class="animated" alt="" />
                </p>
            </div>
        </div>
    </header>
    ...
    <div class="container content content-light home-1">
        ...
        <section class="row animation-scroll">
            ...
            <div class="col-md-6 animated widget-social" data-animation="bounceInRight">
                ...
                <a class="btn btn-social btn-social-circle social-twitter" href="http://localhost/dt/public/static/index/https://twitte/KLWebmedia"><i class="fa fa-twitter"></i><span class="click-number">24</span></a>
    ...
    <div class="copyrights">Collect from <a href="http://localhost/dt/public/static/index/http://www.cssmoba/" >企业网站模板</a></div>
    ...
    <section class="content content-dark testimonial">
        <div class="container">
            ...
            <div class="face">
                ...
                <a href="http://localhost/dt/public/static/index/#tab-henry-cavill" data-toggle="tab"><img src="http://localhost/dt/public/static/index/img/65x65.gif" alt="Henry Cavill" /></a>
                <a href="http://localhost/dt/public/static/index/#tab-andres-gertrudix" data-toggle="tab"><img src="http://localhost/dt/public/static/index/img/65x65.gif" alt="Andres Gertrudix" /></a>
                <a href="http://localhost/dt/public/static/index/#tab-justin-biber" data-toggle="tab"><img src="http://localhost/dt/public/static/index/img/65x65.gif" alt="Justin Biber" /></a>
            </div>
